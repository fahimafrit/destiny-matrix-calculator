...
// The Relationship/Union/Harmony summary only exists for compatibilityData,
// so it's shown for the Compatibility tab and hidden for Person 1 / Person 2.
function updateCompatGridVisibility(tab) {
  if (!compatGrid) return;
  compatGrid.style.display = tab === 'compatibility' ? '' : 'none';
}
